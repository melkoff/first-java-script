...
// let filteredPosts = POSTS.filter((post) => post.id % 2 != 0);
...
// Different method of filtration END //
...
// OR THIS CHOICE //
// const age = ageOne.concat(ageTwo);
...
// // 2. Format data (best structure)
// let postsStruture = posts.map((post) => {
//    return {
//       id: post.id,
//       ...post.attributes,
//    }
// })
// // 3. Filtered post with cost >= 10000
// let postsFiltered = postsStruture.filter((post) => {
//    return post.cost >= 10000
// })
// // 4. Sort posts by title (alphabetically)
...
//    let html =`
//    <div></div>`;
//    document.querySelector(".назва класу").innerHTML += html;
// })